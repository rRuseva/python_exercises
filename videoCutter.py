...
def FrameExtract(video_path, dest_path, start_time, end_time, frame_ext):

    video_obj = cv2.VideoCapture(video_path)
    video_name = str(video.split(".mp4")[0])
    ...
    # print("reading...: \n\tname:\t\t{} \n\tresolutuion:\t{}x{} \n\tfps:\t\t{} \n\tlenght:\t\t{}sec ({} framse) \n  ".format(video_name, int(width), int(height), fps, int(video_duration), int(total_frame_count)))
...
if __name__ == '__main__':
    ...
    ap.add_argument("-s", "--start_time", required=False, type=int, default=1, help="The number of frames to be extracted.")
    ap.add_argument("-e", "--end_time", required=False, type=str, default='png', help="The file format of the extracted frame.")
    args = ap.parse_args()
